# most of this was taken from https://gist.github.com/sumeet/1123871

import time
from math import floor
from paip.helpers.language import seconds_to_hms_string
...
class Stopwatch(object):
    ...
    @property
    def nice_total_run_time(self):
        rounded_seconds = floor(self.total_run_time)
        return seconds_to_hms_string(rounded_seconds)
